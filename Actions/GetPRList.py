...
if not pr_data:
    ...
    # 直接保存到根目录下
    output_json = " ./UpdateHomepage-Build/PRDatabase.json"  # 不用 os.path.join 直接指定文件名
    output_xaml = "./UpdateHomepage-Build/libraries/Homepage/PRList.xaml"  # 不用 os.path.join 直接指定路径
